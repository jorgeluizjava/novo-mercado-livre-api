...
@Component
public class NotificaSucessoNovaCompraParaUsuarioListener implements ApplicationListener<NovoPagamentoEvent>, Ordered {
    ...
    public void onApplicationEvent(NovoPagamentoEvent novoPagamentoEvent) {
        ...
        if (pagamento.comSucesso()) {
            ...
            String corpo = String.format("Seu pagamento id: %s foi realizado com sucesso. \n Seu produto: %s, com quantidade: %d no valor total de: %s já está sendo separado, \n Visualizar detalhe produto: %s",
                                        pagamento.getId(),
                                        produto.getNome(),
